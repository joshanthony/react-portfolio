            ...
            <div className="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto pt-10">
                <div className="hero-wrapper grid grid-cols-1 md:grid-cols-10 gap-8 items-center">
                    <div className="hero-text col-span-10 lg:col-span-6 order-2 md:order-1">
                        ...
                        <p className="text-slate-200 text-2xl leading-relaxed mt-8">
                            I'm a full-stack developer building exceptional digital experiences using technologies such as C# .NET, JavaScript and more.
                            I'm currently focused on building accessible, human-centered products at one of the largest investment funds in Australia.
                        </p>
